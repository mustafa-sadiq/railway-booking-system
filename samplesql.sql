...
select * from reservation where cust_username = 'parth123';
/*delete from customers where cust_username='parth123';
delete from reservation where reservation_num=1; sample deletion*/
select cust_email from customers,reservation where employee='employee1' and reservation.cust_username=customers.cust_username;